...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    Optional<List<Event>> findAllByTeacher(Teacher teacher, Pageable pageable);
    Optional<List<Event>> findAllByTeacher(Teacher teacher);
    Optional<List<Event>> findAllByTeacherAndSubject(Teacher teacher, Subject subject, Pageable pageable);
